/**
* Aerojet Rocketdyne Virtual Booth
**********************************************************************
	Class: AR_VirtualBooth
	Description: Aerojet Rocketdyne Virtual Booth interactive.
**********************************************************************
* 
...
let AR_VirtualBooth = function () {
  ...
  function constructor() {
    ...
    try {
      ...
      json_xhr.open("GET", "json/aerojet_rocketdyne_virtual_booth.json");
      ...
      console.error("<<AR_VirtualBooth constructor>> ERROR: " + error);
    }
  }
  ...
  function products_setup() {
    ...
    //console.log("<<AR_VirtualBooth products_setup>> --is-mobile: " + window.getComputedStyle(document.body).getPropertyValue("--is-mobile"));
    ...
    for (product_index in _products_info) {
      ...
      //console.log("<<AR_VirtualBooth products_setup>> product_index: " + product_index);
      ...
      if( currTargetBtn_info != null ) {
        ...
        //console.log("<<AR_VirtualBooth products_setup>> image_ref: " + currProduct.target_button.image_ref);
        ...
        $.get("img/" + currTargetBtn_info.image_ref, function (data) {
          ...
          //console.log("<<AR_VirtualBooth products_setup>> LOADED product_index: " + product_index + "  title: " + currProduct.title);
          ...
          currTarget_btn.find("g").each(function (g_index, currG) {
            ...
            try {
              ...
              if( currGroup.attr("id") == "hitspot_mc" ) {
                ...
                let label_width_offset = currTargetBtn_info.label_width_offset;
                try{label_width_offset = label_width_offset ? Number(label_width_offset.replace(/px/gi, "")) : 0;}catch(error){label_width_offset = 0;}
                currLabelContainer.css("width", currLabelContainer.width() + label_width_offset + "px");
                currLabelContainer.css("margin-left", -Math.abs(((currLabelContainer.outerWidth() + label_width_offset) / 2) - (currTarget_btn.outerWidth() / 2)) + "px");
              }
            } catch(error) {
              console.error("<<AR_VirtualBooth products_setup>> ERROR: " + error);
            }
          });
        });
      }
      ...
      for (button_index in currProduct.buttons) {
        ...
        try {
          ...
          //console.log("<<AR_VirtualBooth products_setup>> button_index: " + button_index + "  label: " + currButton_info.label);
        } catch (error) {
          console.error("<<AR_VirtualBooth products_setup>> ERROR: " + error);
        }
      }
      ...
      //console.log("<<AR_VirtualBooth products_setup>> left: " + currPopup.css("left") + "  top: " + currPopup.css("top"));
      //console.log("<<AR_VirtualBooth products_setup>> left: " + currPopup[0].getBBox().x + "  top: " + currPopup[0].getBBox().y);
    }
  }
  ...
  function onProductButtonStateChange(stateType) {
    ...
    return function (event) {
      ...
      try {
        ...
        //console.log("<<AR_VirtualBooth onProductButtonStateChange>> stateType: " + stateType);
        ...
        console.error("<<AR_VirtualBooth onProductButtonStateChange>> ERROR: " + error);
      }
    }
  }
    ...
    try {
      ...
      if (_root_info.isMobile) {
        ...
        currPopup.find("#mobile-contents-container-" + currPopup.parent().data("index")).children().each(function (content_index, currContent) {
          ...
          //console.log("<<AR_VirtualBooth onProductContentChange>> content_index: " + content_index + "  currContent: " + currContent);
      ...
      console.error("<<AR_VirtualBooth onProductContentChange>> ERROR: " + error);
    }
  }
  ...
  function popupReset(currPopup) {
    ...
    try {
      ...
      //console.log("<<AR_VirtualBooth popupReset>> isMobile: " + _root_info.isMobile + "  currPopup: " + currPopup.attr("id"));
      ...
      console.error("<<AR_VirtualBooth popupReset>> ERROR: " + error);
    }
  }
  ...
  function updateProjector() {
    ...
    try {
      ...
      //console.log("<<AR_VirtualBooth updateProjector>> isMobile: " + _root_info.isMobile);
      ...
      console.error("<<AR_VirtualBooth updateProjector>> ERROR: " + error);
    }
  }
  ...
  function ieGetStyle(className, propertyName) {
    ...
    try {
      ...
      console.error("<<AR_VirtualBooth ieGetStyle>> ERROR: " + error);
    }
...
document.onreadystatechange = function (event) {
  ...
  //console.log("<<AR_VirtualBooth onreadystatechange>> document.readyState: " + document.readyState);
...
window.onload = function arVirtualBooth_init() {

  _arVirtualBooth = new AR_VirtualBooth();
