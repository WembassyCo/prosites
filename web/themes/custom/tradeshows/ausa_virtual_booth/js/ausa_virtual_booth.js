/**
* Aerojet Rocketdyne AUSA Virtual Booth
**********************************************************************
	Class: AUSAVirtualBooth
	Description: AUSA Virtual Booth interactive.
**********************************************************************
* 
...
let AUSAVirtualBooth = function () {
  ...
  function constructor() {
    ...
    try {
      ...
      json_xhr.open("GET", "json/ausa_virtual_booth.json");
      ...
      console.error("<<AUSAVirtualBooth constructor>> ERROR: " + error);
    }
  }
  ...
  function products_setup() {
    ...
    //console.log("<<AUSAVirtualBooth products_setup>> --is-mobile: " + window.getComputedStyle(document.body).getPropertyValue("--is-mobile"));
    ...
    for (product_index in _products_info) {
      ...
      //console.log("<<AUSAVirtualBooth products_setup>> product_index: " + product_index);
      ...
      if( currTargetBtn_info != null ) {
        ...
        //console.log("<<AUSAVirtualBooth products_setup>> image_ref: " + currProduct.target_button.image_ref);
        ...
        $.get("img/" + currTargetBtn_info.image_ref, function (data) {
          ...
          //console.log("<<AUSAVirtualBooth products_setup>> LOADED product_index: " + product_index + "  title: " + currProduct.title);
          ...
          currTarget_btn.find("g").each(function (g_index, currG) {
            ...
            try {
              ...
              if( currGroup.attr("id") == "hitspot_mc" ) {
                ...
                currLabelContainer.css("width", label_width + LABEL_PADDING + "px");
                currLabelContainer.css("margin-left", -Math.abs((label_width / 2) - (currTarget_btn.outerWidth() / 2)) + "px");
              }
            } catch (error) {
              console.error("<<AUSAVirtualBooth products_setup>> ERROR: " + error);
            }
          });
        });
      }
      ...
      for (button_index in currProduct.buttons) {
        ...
        try {
          ...
          //console.log("<<AUSAVirtualBooth products_setup>> button_index: " + button_index + "  label: " + currButton_info.label);
        } catch (error) {
          console.error("<<AUSAVirtualBooth products_setup>> ERROR: " + error);
        }
      }
      ...
      //console.log("<<AUSAVirtualBooth products_setup>> left: " + currPopup.css("left") + "  top: " + currPopup.css("top"));
      //console.log("<<AUSAVirtualBooth products_setup>> left: " + currPopup[0].getBBox().x + "  top: " + currPopup[0].getBBox().y);
    }
  }
  ...
  function onProductButtonStateChange(stateType) {
    ...
    return function (event) {
      ...
      try {
        ...
        //console.log("<<AUSAVirtualBooth onProductButtonStateChange>> stateType: " + stateType);
        ...
        console.error("<<AUSAVirtualBooth onProductButtonStateChange>> ERROR: " + error);
      }
    }
  }
    ...
    try {
      ...
      if (_root_info.isMobile) {
        ...
        currPopup.find("#mobile-contents-container-" + currPopup.parent().data("index")).children().each(function (content_index, currContent) {
          ...
          //console.log("<<AUSAVirtualBooth onProductContentChange>> content_index: " + content_index + "  currContent: " + currContent);
      ...
      console.error("<<AUSAVirtualBooth onProductContentChange>> ERROR: " + error);
    }
  }
  ...
  function popupReset(currPopup) {
    ...
    try {
      ...
      //console.log("<<AUSAVirtualBooth popupReset>> isMobile: " + _root_info.isMobile + "  currPopup: " + currPopup.attr("id"));
      ...
      console.error("<<AUSAVirtualBooth popupReset>> ERROR: " + error);
    }
  }
  ...
  function updateProjector() {
    ...
    try {
      ...
      //console.log("<<AUSAVirtualBooth updateProjector>> isMobile: " + _root_info.isMobile);
      ...
      console.error("<<AUSAVirtualBooth updateProjector>> ERROR: " + error);
    }
  }
  ...
  function ieGetStyle(className, propertyName) {
    ...
    try {
      ...
      console.error("<<AUSAVirtualBooth ieGetStyle>> ERROR: " + error);
    }
...
const SECOND = 1000;
let _ausaVirtualBooth;
document.onreadystatechange = function (event) {

  //console.log("<<AUSAVirtualBooth onreadystatechange>> document.readyState: " + document.readyState);
...
window.onload = function ausaVirtualBooth_init() {

  _ausaVirtualBooth = new AUSAVirtualBooth();
