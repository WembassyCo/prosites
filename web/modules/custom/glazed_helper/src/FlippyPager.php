...
class FlippyPager {
   ...
   *   Drupal Language manager service.
   */
  public function __construct(EntityFieldManagerInterface $entityFieldManager, EventDispatcherInterface $event_dispatcher, EntityTypeManagerInterface $entityTypeManager, Connection $connection, ConfigFactoryInterface $config_factory, LanguageManager $languageManager) {
